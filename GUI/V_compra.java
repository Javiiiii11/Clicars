...
public class V_compra extends JFrame {
...
// lanzar aplicacion
	 ...
	 * Crear marco
	 */
	public V_compra(Cliente cliente) {
	...
	public V_compra() {
		setTitle("Clicars");
		setIconImage(Toolkit.getDefaultToolkit().getImage(V_compra.class.getResource("/imagenes/2.png")));
		...
		lblcarretera.setIcon(new ImageIcon(V_compra.class.getResource("/imagenes/carretera.png")));
		...
		lblcarretera2.setIcon(new ImageIcon(V_compra.class.getResource("/imagenes/carretera.png")));
...
//		panel_2.setBackground(new Color(203, 41, 41));
        ...
        btncarrito.setIcon(new ImageIcon(V_compra.class.getResource("/iconos/comprar_carrito.png")));
//        btncarrito.setIcon(new ImageIcon(V_alquilar.class.getResource("/iconos/mas1.png")));
        btncarrito.setBounds(43, 11, 77, 75);
        panelCatalogo.add(btncarrito);
        btncarrito.setBorderPainted(false);
        btncarrito.setBackground(new Color(128, 128, 128));
		...
		JButton btncomprar = new JButton("");
		btncomprar.setIcon(new ImageIcon(V_compra.class.getResource("/iconos/confirmacion compra-small-small.png")));
		...
		btncomprar.addActionListener(e -> {
		    ...
		    if (opcion == 0) {
				V_ConfirmacionCompraAlquiler v_ConfirmacionCompraAlquiler = new V_ConfirmacionCompraAlquiler(cliente,matriculas,false,new LinkedList<Integer>() );
...
//			tabla.addRow(titulos);
	 ...
	 public boolean seleccionarVehiculo() {
	        String buscar = JOptionPane.showInputDialog("Introduce la matricula del coche que quieras comprar: ");
	        ...
	        if (new ConexionBD().existeVehiculo(buscar)) {
	            int resultado = JOptionPane.showConfirmDialog(null, String.format("¿Se confirmara la compra estas seguro?\nEl precio seria %.2f €",new ConexionBD().BuscarPrecio(buscar)), "Confirmacion", JOptionPane.YES_NO_OPTION);
                 if (resultado==0) {
                		JOptionPane.showMessageDialog(null, "Vehiculo añadido correctamente\nMatricula : " + buscar  ,"Exito", JOptionPane.INFORMATION_MESSAGE);
