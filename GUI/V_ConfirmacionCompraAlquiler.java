...
public class V_ConfirmacionCompraAlquiler extends JPanel {
    ...
    public V_ConfirmacionCompraAlquiler(Cliente cliente, ArrayList<String> matriculas, boolean alquilado, LinkedList<Integer> dias) {
        ...
        bucleTareasVehiculos(vehiculos);
    ...
    /**BUCLE PARA CREAR LOS VEHICULOS*/
    
    public void bucleTareasVehiculos(ArrayList<Vehiculo> tareas) {
        for (Vehiculo tareaInfo : tareas) {
            JPanel tarea = crearTareaVehiculo(tareaInfo);
    ...
    /**CREA LAS TARJETAS CON COCHES SELECCIONADOS*/

    public JPanel crearTareaVehiculo(Vehiculo vehiculo) {
