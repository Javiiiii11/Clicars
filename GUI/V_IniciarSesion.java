...
public class V_IniciarSesion extends JFrame {
	...
	private void mandar() { // Metodo que comprueba que el dni y la contraseña son correctos y lanza la aplicacion
		...
		if (camposValidos) {
			...
			try {
				...
				if (rs.next()) {
					...
					if (!(contraseña.equals(txtcontraseña.getText()))) { // La contraseña debe ser igual (mayusculas y minusculas)
